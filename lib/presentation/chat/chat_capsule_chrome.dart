...
EdgeInsets chatMessageViewportPadding(
  ...
  return EdgeInsets.fromLTRB(
    horizontal,
    reserveTopOverlay ? chatMessageTopOverlayClearanceFor(context) : 0,
    horizontal,
...
double chatMessageTopOverlayClearanceFor(BuildContext context) {
                    ...
                    child: Row(
                      ...
                      children: [
                        _FigmaGlassCircleButton(
                          ...
                          child: detailAction.icon == Symbols.more_vert
                              ? _chatAsset(
                                  _assetChatMore,
                                  size: 17,
                                  color: t.text,
                              ...
                              : Icon(
                                  detailAction.icon,
                                  size: 24,
                                  color: detailAction.color ?? t.text,
                                ),
                        ),
                      ],
                    ),
...
class _ChatCapsuleInputBarState extends State<ChatCapsuleInputBar> {
  ...
  Widget build(BuildContext context) {
    ...
    const buttonSize = _composerButtonSize;
    const fieldHeight = _composerFieldHeight;
    const fieldRadius = _composerFieldRadius;
    const buttonGap = 8.0;
